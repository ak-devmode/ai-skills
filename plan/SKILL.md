...
and stop at human checkpoints. A plan is the unit of work that fits in one context window
(~200k tokens, ~1 session). Plans may be standalone or generated by /scope as phase stubs.
